...
public class Config {
    ...
    public static final int Home_Scene_User = 3;
    public static final int Home_Scene_Hub = 4;
    public static final int Home_Scene_DeliverAgent = 5;
    public static final int Home_Scene_EnterPrise = 6;
